    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title w-100" id="myModalLabel">Add Registration state</h5>
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title w-100" id="myModalLabel">Update Registration State</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                Are you sure you want to delete this registration state?
            </div>
...
<script>
    $(document).ready( function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (d.error.length > 0) {
                        ...
                        $('#addModal').modal('hide')
                        $('#registrationsTable').DataTable().draw()
                        toastr.success('Registration state added successfully', {timeOut:5000})
                    }
                },
                error: function(xhr){
                    console.log(xhr)
        ...
        $('.updateButton').click(function () {
            ...
            $.ajax({
                url: "/admin/registrations/"+id+"/update",
                method: "PUT",
                data: {
                    "_token": '{{ csrf_token() }}',
                    "name": newName
                ...
                success: function (data) {
                    ...
                    if (d.error.length > 0) {
                        ...
                        $('#registrationsTable').DataTable().draw()
                        toastr.success('Registration state updated successfully', {timeOut:5000})
                    }
                },
                error: function(xhr){
                    console.log(xhr)
        ...
        $('#confirmDelete').click(function () {
            ...
            $.ajax({
                ...
                success: function (e) {
                    ...
                    toastr.success('Registration state Deleted', {timeOut:5000})
                },
