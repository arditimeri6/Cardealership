...
<div class="row">
    <div class="col-lg-8 offset-lg-2 col-md-10 offset-md-1">
        <div class="card mb-3">
            ...
            <div class="card-body">
                <table class="table table-hover" id="transmissionTable">
                    <thead>
                        <tr>
                            <th>Name</th>
                            <th>Created At</th>
    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title w-100" id="myModalLabel">Add Transmission</h5>
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title w-100" id="myModalLabel">Update Transmission</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<script>
    $(document).ready( function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (d.error.length > 0) {
                        ...
                        $('#addModal').modal('hide')
                        $('#transmissionTable').DataTable().draw()
                        toastr.success('Transmission added successfully', {timeOut:5000})
                    }
                },
                error: function(xhr){
                    console.log(xhr)
        ...
        $('.updateButton').click(function () {
            ...
            $.ajax({
                url: "/admin/transmissions/"+id+"/update",
                method: "PUT",
                data: {
                    "_token": '{{ csrf_token() }}',
                    "name": newName
                ...
                success: function (data) {
                    ...
                    if (d.error.length > 0) {
                        ...
                        $('#transmissionTable').DataTable().draw()
                        toastr.success('Body type updated successfully', {timeOut:5000})
                    }
                },
                error: function(xhr){
                    console.log(xhr)
        ...
        $('#confirmDelete').click(function () {
            ...
            $.ajax({
                ...
                url: '/admin/transmissions/'+id,
                success: function (e) {
                    $('#transmissionTable').DataTable().draw()
                    $('#deleteModal').modal('hide')
                    toastr.success('Body type Deleted', {timeOut:5000})
                },
