...
<div class="row">
    <div class="col-lg-8 offset-lg-2 col-md-10 offset-md-1">
        <div class="card mb-3">
            ...
            <div class="card-body">
                <table class="table table-hover" id="cylindersTable">
                    <thead>
                        <tr>
                            <th>Amount</th>
                            <th>Created At</th>
    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title w-100" id="myModalLabel">Add Cylinders number</h5>
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title w-100" id="myModalLabel">Update Cylinder number</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                Are you sure you want to delete this cylinder number?
            </div>
...
<script>
    $(document).ready( function () {
        $('#cylindersTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{!! route('get.cylinders') !!}',
            columns: [
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (d.error.length > 0) {
                        ...
                        $('#addModal').modal('hide')
                        $('#cylindersTable').DataTable().draw()
                        toastr.success('Cylinder number added successfully', {timeOut:5000})
                    }
                },
                error: function(xhr){
                    console.log(xhr)
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (d.error.length > 0) {
                        ...
                        $('#cylindersTable').DataTable().draw()
                        toastr.success('Cylinder number updated successfully', {timeOut:5000})
                    }
                },
                error: function(xhr){
                    console.log(xhr)
        ...
        $('#confirmDelete').click(function () {
            ...
            $.ajax({
                ...
                url: '/admin/cylinders/'+id,
                success: function (e) {
                    $('#cylindersTable').DataTable().draw()
                    $('#deleteModal').modal('hide')
                    toastr.success('Cylinder number Deleted', {timeOut:5000})
                },
