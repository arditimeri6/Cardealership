...
<div class="row">
    <div class="col-lg-8 offset-lg-2 col-md-10 offset-md-1">
        <div class="card mb-3">
            ...
            <div class="card-body">
                <table class="table table-hover" id="horsepowerTable">
                    <thead>
                        <tr>
                            <th>Amount</th>
                            <th>Created At</th>
    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title w-100" id="myModalLabel">Add HP number</h5>
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title w-100" id="myModalLabel">Update HP number</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                Are you sure you want to delete this HP number?
            </div>
...
<script>
    $(document).ready( function () {
        $('#horsepowerTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{!! route('get.horsepowers') !!}',
            columns: [
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (d.error.length > 0) {
                        ...
                        $('#addModal').modal('hide')
                        $('#horsepowerTable').DataTable().draw()
                        toastr.success('Horsepower added successfully', {timeOut:5000})
                    }
                },
                error: function(xhr){
                    console.log(xhr)
        ...
        $('.updateButton').click(function () {
            ...
            $.ajax({
                url: "/admin/horsepowers/"+id+"/update",
                method: "PUT",
                data: {
                    "_token": '{{ csrf_token() }}',
                    "amount": newAmount
                ...
                success: function (data) {
                    ...
                    if (d.error.length > 0) {
                        ...
                        $('#horsepowerTable').DataTable().draw()
                        toastr.success('Horsepower updated successfully', {timeOut:5000})
                    }
                },
                error: function(xhr){
                    console.log(xhr)
        ...
        $('#confirmDelete').click(function () {
            ...
            $.ajax({
                ...
                url: '/admin/horsepowers/'+id,
                success: function (e) {
                    $('#horsepowerTable').DataTable().draw()
                    $('#deleteModal').modal('hide')
                    toastr.success('Horsepower Deleted', {timeOut:5000})
                },
