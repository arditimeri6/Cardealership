...
<div class="row">
    <div class="col-lg-8 offset-lg-2 col-md-10 offset-md-1">
        <div class="card mb-3">
            ...
            <div class="card-body">
                <table class="table table-hover" id="bodyTypesTable">
                    <thead>
                        <tr>
                            <th>Name</th>
                            <th>Created At</th>
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title w-100" id="myModalLabel">Update Body Type</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<script>
    $(document).ready( function () {
        $('#bodyTypesTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{!! route('get.body_types') !!}',
            columns: [
                { data: 'name', name: 'name' },
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (d.error.length > 0) {
                        ...
                        $('#addModal').modal('hide')
                        $('#bodyTypesTable').DataTable().draw()
                        toastr.success('Body type added successfully', {timeOut:5000})
                    }
                },
                error: function(xhr){
                    console.log(xhr)
        ...
        $('.updateButton').click(function () {
            ...
            $.ajax({
                url: "/admin/body_types/"+id+"/update",
                method: "PUT",
                data: {
                    "_token": '{{ csrf_token() }}',
                    "name": newName
