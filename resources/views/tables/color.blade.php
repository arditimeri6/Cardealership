    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title w-100" id="myModalLabel">Add Color</h5>
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title w-100" id="myModalLabel">Update Color</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (d.error.length > 0) {
                        ...
                        $('#addModal').modal('hide')
                        $('#colorsTable').DataTable().draw()
                        toastr.success('Color added successfully', {timeOut:5000})
                    }
                },
                error: function(xhr){
                    console.log(xhr)
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (d.error.length > 0) {
                        ...
                        $('#colorsTable').DataTable().draw()
                        toastr.success('Color updated successfully', {timeOut:5000})
                    }
                },
                error: function(xhr){
                    console.log(xhr)
        ...
        $('#confirmDelete').click(function () {
            ...
            $.ajax({
                ...
                success: function (e) {
                    ...
                    toastr.success('Color Deleted', {timeOut:5000})
                },
