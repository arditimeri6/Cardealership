...
class ConditionsController extends Controller
{
    ...
    {
        return view('tables.condition');
    }
    public function getData()
    {
        return Datatables::of(DB::table('conditions')->get())
        ->addColumn('actions', '
    ...
    public function store(Request $request)
    {
        $validation = Validator::make($request->all(), [
            ...
            'name.required' => 'Condition is required',
            'name.unique' => 'Condition is already registered',
        ]);
        // dd($validation);
        $error_array = array();
        $success_output = '';
    ...
    public function edit(Request $request, $id)
    {
        ...
        if ($validation->fails()) {
            ...
            DB::table('conditions')->where('id', $id)->update([
                'name' => $request->name,
                'updated_at' => Carbon::now()
            ]);
        }
